...
def main():
    ...
    if choice == "1":
        ...
        print(
            "Previewing the first 1000 characters:\n" + parsed["full_text"][:1000],
            "...",
        )
    elif choice == "3":
        docs = pipeline.process_single_pdf(
            file_path, output_format="langchain", chunk_documents=False
        )
        ...
        docs = pipeline.process_single_pdf(
            file_path, output_format="langchain", chunk_documents=True
        )
        ...
        print(
            "Showing the first 3 pages and first 500 characters of the text from each page."
        )
